...
type TalkStats struct {
	forward_error atomic2.Int64
	client_error  atomic2.Int64
}

var talkStats TalkStats

func incrForwardErrors() {
	talkStats.forward_error.Incr()
}

func incrClientErrors() {
	talkStats.client_error.Incr()
}

func ForwardErrors() int64 {
	return talkStats.forward_error.Get()
}

func ClientErrors() int64 {
	return talkStats.client_error.Get()
}
